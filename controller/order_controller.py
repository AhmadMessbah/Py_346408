...
class OrderController:
    ...
    def find_by_order_type(self, order_type):
        try:
            service = OrderService()
            return True, service.find_by_order_type(order_type)
        except Exception as e:
            return False, e
    ...
    def find_by_customer_id(self, customer_id):
        try:
            service = OrderService()
            return True, service.find_by_customer_id(customer_id)
        except Exception as e:            
            return False, e
    ...
    def find_by_employee_id(self, employee_id):
        try:
            service = OrderService()
            return True, service.find_by_employee_id(employee_id)
        except Exception as e:            
            return False, e
