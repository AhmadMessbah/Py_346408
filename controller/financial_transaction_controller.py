...
class FinancialTransactionController:
    financial_transaction_service = FinancialTransactionService()
    ...
    def save(cls, transaction_type, customer_id, employee_id, amount, date_time, payment_id, description):
        try:
            ...
            financial_transaction = cls.financial_transaction_service.save(financial_transaction)
    ...
    def update(cls, financial_transaction_id, transaction_type, customer_id, employee_id, amount, date_time, payment_id, description):
        try:
            financial_transaction = FinancialTransaction(financial_transaction_id, transaction_type, customer_id, employee_id, amount,
                                                         date_time, payment_id, description)
            financial_transaction = cls.financial_transaction_service.update(financial_transaction)
    ...
    def delete(cls, financial_transaction_id):
        try:
            financial_transaction = cls.financial_transaction_service.delete(financial_transaction_id)
    ...
    def find_by_id(cls, financial_transaction_id):
        try:
            financial_transaction = cls.financial_transaction_service.find_by_id(financial_transaction_id)
    ...
    def find_by_transaction_type(cls, transaction_type):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_transaction_type(transaction_type)
    ...
    def find_by_customer_id(cls, customer_id):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_customer_id(customer_id)
    ...
    def find_by_employee_id(cls, employee_id):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_employee_id(employee_id)
    ...
    def find_by_payment_id(cls, payment_id):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_payment_id(payment_id)
    ...
    def find_by_date_time_range(cls, start_date_time, end_date_time):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_date_time_range(start_date_time, end_date_time)
    ...
    def find_by_date_time_range_and_customer_id(cls, start_date_time, end_date_time, customer_id):
        try:
            financial_transaction_list = cls.financial_transaction_service.find_by_date_time_range_and_customer_id(start_date_time, end_date_time, customer_id)
