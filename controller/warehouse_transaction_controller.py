...
class WarehouseTransactionController:
    def __init__(self):
        self.warehouse_transaction_service = WarehouseTransactionService()
    ...
    def save(self, product_id, quantity, transaction_type, transaction_datetime, customer_id, employee_id):
        try:
            ...
            warehouse_transaction = self.warehouse_transaction_service.save(warehouse_transaction)
    ...
    def update(self, warehouse_transaction_id, product_id, quantity, transaction_type, transaction_datetime, customer_id, employee_id):
        try:
            warehouse_transaction = WarehouseTransaction(warehouse_transaction_id, product_id, quantity, transaction_type,
                                                         transaction_datetime, customer_id, employee_id)
            warehouse_transaction.validate()
            warehouse_transaction = self.warehouse_transaction_service.update(warehouse_transaction)
    ...
    def delete(self, warehouse_transaction_id):
        try:
            warehouse_transaction = self.warehouse_transaction_service.delete(warehouse_transaction_id)
    ...
    def find_all(self):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_all()
    ...
    def find_by_id(self, warehouse_transaction_id):
        try:
            warehouse_transaction = self.warehouse_transaction_service.find_by_id(warehouse_transaction_id)
    ...
    def find_by_product_id(self, product_id):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_product_id(product_id)
    ...
    def find_by_transaction_type(self, transaction_type):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_transaction_type(transaction_type)
    ...
    def find_by_customer_id(self, customer_id):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_customer_id(customer_id)
    ...
    def find_by_employee_id(self, employee_id):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_employee_id(employee_id)
    ...
    def find_by_date_time_range(self, start_date_time, end_date_time):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_date_time_range(start_date_time, end_date_time)
    ...
    def find_by_date_time_range_and_customer_id(self, start_date_time, end_date_time, customer_id):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_date_time_range_and_customer_id(start_date_time, end_date_time, customer_id)
    ...
    def find_by_date_time_range_and_employee_id(self, start_date_time, end_date_time, employee_id):
        try:
            warehouse_transaction_list = self.warehouse_transaction_service.find_by_date_time_range_and_employee_id(start_date_time, end_date_time, employee_id)
