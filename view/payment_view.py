...
class PaymentView:
    def __init__(self):
        ...
        self.transaction_type = LabelWithEntry(self.window, "TransactionType", 20, 60)
        ...
        self.table = Table(
            self.window,
            ["Id", "TransactionType", "PaymentType", "DateTime", "CustomerId", "TotalAmount", "EmployeeId", "Description"],
    ...
    def save_click(self):
        ...
        if status:
            messagebox.showinfo("Payment Saved", message)
            self.reset_form()
        else:
    ...
    def delete_click(self):
        ...
        if status:
            messagebox.showinfo("Payment Deleted", message)
            self.reset_form()
        else:
